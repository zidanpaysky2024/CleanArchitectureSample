        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BriefAr = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    BriefEn = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    BriefFr = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    IsAvailable = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "0"),
                    ApplyingDate = table.Column<DateTime>(type: "DateTime", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastUpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastUpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AvailableProductsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CategoriesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryProduct", x => new { x.AvailableProductsId, x.CategoriesId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_CategoryProduct_Product_AvailableProductsId",
